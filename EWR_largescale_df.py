...
def train():
    ...
    defocus_series = torch.nn.Parameter(defocus_series)
    
    # Define optimizer for defocus_series
    optimizer_defocus = torch.optim.Adam([defocus_series], lr=2, betas=(0.9, 0.999), eps=1e-8, weight_decay=0)
    scheduler_defocus = torch.optim.lr_scheduler.ExponentialLR(optimizer_defocus, gamma=0.99)
